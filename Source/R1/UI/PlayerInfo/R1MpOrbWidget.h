...
public:
	...
	// MP 텍스트 오버레이 표시 토글 (호버 히트박스 등 외부에서 호출)
	void SetMpTextVisible(bool bVisible);
...
protected:
	...
	// WBP_Orb_MP 안에 "MpTextUI" 이름으로 배치된 자식 위젯 (이름 일치 필수). 호버 시 표시.
	UPROPERTY(meta = (BindWidget))
	TObjectPtr<class UR1MpTextUI> MpTextUI;
