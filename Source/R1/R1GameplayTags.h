...
namespace R1GameplayTags
{
	...
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Cooldown_Boss_BabyWave);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Cooldown_Boss_BabySummon);
	...
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Cooldown_Boss_WardenLeapAttack);
